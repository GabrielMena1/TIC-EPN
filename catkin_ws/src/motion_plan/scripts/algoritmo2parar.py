...
def take_action(regions):
  ...
  def show_gazebo_models1(blockName):
    ...
    print("------- ROBOT OBRERO 1 ENCONTRO LA ESFERA------------")
...
def main():
  ...
  pub = rospy.Publisher('/cmd2_vel2', Twist, queue_size=1)
  
  sub = rospy.Subscriber('/robot2/laser2/scan2', LaserScan, callback_laser)
 # mover_objetos1()
  rospy.spin()

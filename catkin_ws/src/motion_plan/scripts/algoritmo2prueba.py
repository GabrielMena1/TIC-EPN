...
def take_action(regions):
 ...
 #   angular_z = 0
    ...
    mover_objetos3()
    print(otro1,otro2)
    if valorx2 > valorx1-2.5 and valorx2< valorx1+2.5 and valory2 > valory1-2.5 and valory2 < valory1+2.5: 
      print ("*************************ROBOT OBRERO 1*************************")
                 
                   
      print("Coordenadas del objeto encontrado",valorx1, valory1)
      os.system('rosrun motion_plan algoritmo2parar.py')
    if otro2 < otro1:
      linear_x = linear_speed
      angular_z = 0
    else:
  ...
  def show_gazebo_models3(blockName):
    ...
    print("       Estado robot obrero 2: Buscando")
    print("***Distancia entre robots obreros:",man)
...
def main():
  ...
  rospy.init_node('reading2_laser2')
  
  #print("hola")
  
  pub3 = rospy.Publisher('/cmd2_vel2', Twist, queue_size=1)
  
  sub3 = rospy.Subscriber('/robot2/laser2/scan2', LaserScan, callback_laser)
